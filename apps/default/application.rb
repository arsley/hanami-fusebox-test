...
module Default
  class Application < Hanami::Application
    configure do
      ...
      #
      # sessions :cookie, secret: ENV['DEFAULT_SESSIONS_SECRET']
      ...
      #
      layout :application # It will load Default::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time Default::Action is included
      ...
      # Configure the code that will yield each time Default::View is included
      # This is useful for sharing common functionality
      #
      # See: http://www.rubydoc.info/gems/hanami-view#Configuration
      view.prepare do
        include Hanami::Helpers
        include Default::Assets::Helpers
      end
    end
