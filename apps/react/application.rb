...
module React
  class Application < Hanami::Application
    configure do
      ...
      #
      # sessions :cookie, secret: ENV['REACT_SESSIONS_SECRET']
      ...
      #
      layout :application # It will load React::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time React::Action is included
      ...
      # Configure the code that will yield each time React::View is included
      # This is useful for sharing common functionality
      #
      # See: http://www.rubydoc.info/gems/hanami-view#Configuration
      view.prepare do
        include Hanami::Helpers
        include React::Assets::Helpers
      end
    end
